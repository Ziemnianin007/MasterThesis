...
#coordinateOperationInstance = coordinateOperation.coordinateOperation(plot = True, save = True, emulateOculus = True)
...
neuralNetworkPredictionInstance = neuralNetworkPrediction.DQN("Dobot", emulateOculus = True, visualize = True, teachingFilesPath = "C:\\Users\\jakub\\Documents\\W4\\MasterThesis\\PythonProgram\\tmp\\teach", policyValues = {"inner_policy": EpsGreedyQPolicy(), "attr":"eps", "value_max":0.35, "value_min":.02, "value_test":.0, "nb_steps":2000000})
